...
namespace DXSample {
    ...
    public partial class nwindDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CategoriesDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CategoriesRow AddCategoriesRow(string CategoryName, byte[] Picture) {
...
namespace DXSample.nwindDataSet1TableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Categories` (`CategoryName`, `Picture`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Categories` SET `CategoryName` = ?, `Picture` = ? WHERE ((`CategoryID` = " +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CategoryID, CategoryName, Picture FROM Categories";
        ...
        public virtual int Fill(nwindDataSet1.CategoriesDataTable dataTable) {
        ...
        public virtual nwindDataSet1.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            nwindDataSet1.CategoriesDataTable dataTable = new nwindDataSet1.CategoriesDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(nwindDataSet1.CategoriesDataTable dataTable) {
        ...
        public virtual int Insert(string CategoryName, byte[] Picture) {
        ...
        public virtual int Update(string CategoryName, byte[] Picture, int Original_CategoryID, string Original_CategoryName) {
            if ((CategoryName == null)) {
                throw new global::System.ArgumentNullException("CategoryName");
            }
            else {
