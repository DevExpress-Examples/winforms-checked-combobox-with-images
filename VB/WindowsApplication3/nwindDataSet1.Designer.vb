...
Namespace DXSample
	...
	Partial Public Class nwindDataSet1
		...
		Partial Public Class CategoriesDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCategoriesRow(ByVal CategoryName As String, ByVal Picture() As Byte) As CategoriesRow
				Dim rowCategoriesRow As CategoriesRow = (CType(Me.NewRow(), CategoriesRow))
				Dim columnValuesArray() As Object = { Nothing, CategoryName, Picture}
	...
	End Class
End Namespace
Namespace DXSample.nwindDataSet1TableAdapters
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Categories` (`CategoryName`, `Picture`) VALUES (?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Categories` SET `CategoryName` = ?, `Picture` = ? WHERE ((`CategoryID` = " & "?) AND ((? = 1 AND `CategoryName` IS NULL) OR (`CategoryName` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT CategoryID, CategoryName, Picture FROM Categories"
		...
		Public Overridable Function Fill(ByVal dataTable As nwindDataSet1.CategoriesDataTable) As Integer
		...
		Public Overridable Function GetData() As nwindDataSet1.CategoriesDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New nwindDataSet1.CategoriesDataTable()
		...
		Public Overridable Function Update(ByVal dataTable As nwindDataSet1.CategoriesDataTable) As Integer
		...
		Public Overridable Function Insert(ByVal CategoryName As String, ByVal Picture() As Byte) As Integer
		...
		Public Overridable Function Update(ByVal CategoryName As String, ByVal Picture() As Byte, ByVal Original_CategoryID As Integer, ByVal Original_CategoryName As String) As Integer
			If (CategoryName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("CategoryName")
			Else
